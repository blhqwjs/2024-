			...
			<swiper-item class="swiper-item">
				<record-view v-show="isSearchResultsVisible2" class="record" record-y>
					<view class="record_class">
						<view class="record_item" @click="clickSkip(item)" v-for="(item, index) in recordList"
							:key="index">
			...
			<swiper-item class="swiper-item">
				<collect-view v-show="isSearchResultsVisible2" class="collect" collect-y>
					<view class="collect_class">
						<view class="collect_item" @click="clickSkip(item)" v-for="(item, index) in collectList"
							:key="index">
							<image class="image" :src="item.file_url"></image>
